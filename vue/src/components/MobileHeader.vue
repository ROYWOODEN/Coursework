  ...
  <header class="mobile-header flex flex-row w-full justify-between items-center !px-8">
      ...
      <div class="flex justify-center w-20">
        <img class="" src="/Sitebar/logo.svg" alt="">
            ...
            <div class="!p-2 rounded-full mobile-header__auth-svg-fon">
                <svg class="mobile-header__auth-svg" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
